    ...
    <div className="w-full">
      <div className="max-w-4xl">
        <form method="post" action="" className="w-full flex gap-2">
          ...
          <button
            className="rounded-md border border-transparent bg-indigo-600 py-0 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            onClick={handleAdd}
